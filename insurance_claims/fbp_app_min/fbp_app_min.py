...
class ClassifyClaimComplexity(INode):
    def __init__(self, with_bug=False, **kwargs):
...
class App():
    def __init__(self, with_bug=False, updated=False):
        self.with_bug = with_bug
    ...
    def _build(self) -> Graph:
        ...
        classify_claim_complexity = ClassifyClaimComplexity(graph=graph, with_bug=self.with_bug)
